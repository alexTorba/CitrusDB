...
namespace CitrusDB.View.Students.AddStudent
{
  public partial class AddStudentBoard : UserControl, IAddStudentBoard
  {
    ...
    {
      _mainForm.SetStatusValue = "Saving student..";
    ...
    {
      _mainForm.SetStatusValue = "Searching the students..";
    ...
    private void swingButton_Click(object sender, EventArgs e)
    {
      ...
      _mainForm.TimerTiks += swingPanel.TicksGrowsWidth;
    ...
    {
      _mainForm.SetStatusValue = "Generating values..";
