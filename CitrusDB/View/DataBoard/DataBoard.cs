...
namespace CitrusDB.View.DataBoard
{
  public partial class DataBoard : UserControl, IDataBoard
  {
    ...
    private void radioButtonGroup_MouseClick(object sender, MouseEventArgs e)
    {
      ...
      comboBoxFilters.DataSource = new List<string> { "Name" };
    ...
    private void collapsedData_Click(object sender, EventArgs e)
    {
      ...
      _mainForm.TimerTiks += generPanelOptions.TicksGrowsWidth;
    ...
    private void buttonTables_Click(object sender, EventArgs e)
    {
      ...
      _mainForm.ClearEventHandlers();
      _mainForm.TimerTiks += panelTables.TicksGrowsHeight;
    }
    ...
    {
      _mainForm.SetStatusValue = "Showing info..";

      var id = (int)dataGrid.SelectedCells[0].Value;
    ...
    {
      _mainForm.SetStatusValue = "Deleting entity..";
    ...
    {
      var selectedEntityView = dataGrid.SelectedRows[0].DataBoundItem;
      var selectedEntity = GetEntityBySelectedView?.Invoke(null, new EntityTransferEventArgs((IEntity)selectedEntityView));
    ...
    {
      var selectedHeader = dataGrid.Columns[e.ColumnIndex].DataPropertyName;
    ...
    {
      if (conditionSorting == null) return;
