...
{
    static class EFGenericRepositorySecondary<TEntity> where TEntity : class
    {
        static readonly CitrusDbContext context;

        static EFGenericRepositorySecondary()
        {
        ...
        {
            //SqlParameter par = new SqlParameter("@par", typeof(TEntity).Name.Trim());
