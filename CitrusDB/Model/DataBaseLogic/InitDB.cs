...
namespace CitrusDB.Model.DataBaseLogic
{
  class InitDB : DropCreateDatabaseAlways<CitrusDbContext>
  {
    protected override void Seed(CitrusDbContext context)
    {
      ...
      using (var stream = new FileStream(@"C:\Users\Александр\Documents\Visual Studio 2015\Projects\PrisonerWinF\prisonersPhoto\1\2-Ф.jpg", FileMode.Open, FileAccess.ReadWrite, FileShare.ReadWrite))
      {
